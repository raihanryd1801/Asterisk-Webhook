...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4 font-sans antialiased">
    ...
    <div class="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden border border-slate-200/80">
        ...
        <div class="bg-slate-900 p-8 text-center relative overflow-hidden">
            ...
            <h1 class="text-xl font-bold text-white tracking-tight">Administrator Login</h1>
        ...
        <div class="p-8">
            ...
            <form action="{{ url('/login') }}" method="POST" class="space-y-4">
                @csrf
                <div>
                    <label class="block text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Email Administrator</label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-400"><i class="fa-solid fa-envelope text-xs"></i></span>
            ...
            <p class="text-center text-xs text-slate-500 mt-6 pt-5 border-t border-slate-100">
                ...
                <a href="/agent/login" class="text-brand-600 font-bold hover:underline ml-1">Login via Ekstensi</a>
            </p>
        </div>
    </div>
